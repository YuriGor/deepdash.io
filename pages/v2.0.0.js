...
const mdMain = preval`
      module.exports = require('../preval/md')('docs/v2.0.0');
    `;
// console.log(mdMain);
const styles = (theme) => ({
  ...markdown,
...
function SideContent(props) {
  ...
  return (
    <>
      ...
      <ListItemNextLink href="/changelog#v2-0-0">
        <ListItemIcon>
          <ChangeLogIcon />
        </ListItemIcon>
...
export default withLayout('/v2.0.0', withStyles(styles)(SideContent), withStyles(styles)(Index));
